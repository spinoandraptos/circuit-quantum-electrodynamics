...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div style={{ padding: "1.25rem 1rem 1rem", borderBottom: "2px solid var(--border)" }}>
        <Link href="/" style={{ textDecoration: "none" }}>
          <div style={{ fontFamily: "system-ui, sans-serif", fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--text-muted)", marginBottom: "0.2rem" }}>
            Quantum Engineering
          </div>
          <div style={{ fontFamily: "system-ui, sans-serif", fontSize: "1.1rem", fontWeight: 900, color: "var(--text)", letterSpacing: "-0.02em", lineHeight: 1.1 }}>
      ...
      <nav style={{ padding: "0.75rem 0", flex: 1 }}>
        ...
        {topics.map((topic) => {
          ...
          return (
            <Link key={topic.slug} href={href} style={navLinkStyle(active)}>
              <span style={{ fontFamily: "system-ui, sans-serif", fontSize: "0.65rem", fontWeight: 700, color: active ? "var(--accent-text)" : "var(--text-muted)", minWidth: "1.2rem" }}>
        ...
        <Link href="/resources/papers" style={navLinkStyle(pathname === "/resources/papers")}>
          Latest Papers
        </Link>
      ...
      {/* Footer */}
      <div style={{ padding: "0.75rem 1rem", borderTop: "1.5px solid var(--border-soft)", fontFamily: "system-ui, sans-serif", color: "var(--text-muted)", display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <a href="/about" style={{ fontSize: "0.8rem", fontWeight: 700, color: "var(--text-muted)", textDecoration: "none" }}>
            About Me
          </a>
        </div>
